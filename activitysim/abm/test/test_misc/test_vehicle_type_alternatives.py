...
from activitysim.abm.models.vehicle_type_choice import get_combinatorial_vehicle_alternatives
...
def test_get_combinatorial_vehicle_alternatives():
    ...
    expected_wide = pd.DataFrame(
        {'body_type_Car': {0: 1, 1: 1, 2: 1, 3: 1, 4: 0, 5: 0, 6: 0, 7: 0},
         ...
         'body_type': {0: 'Car', 1: 'Car', 2: 'Car', 3: 'Car', 4: 'Van', 5: 'Van', 6: 'Van', 7: 'Van'},
         'age': {0: '1', 1: '1', 2: '2', 3: '2', 4: '1', 5: '1', 6: '2', 7: '2'},
         'fuel_type': {0: 'Gas', 1: 'PEV', 2: 'Gas', 3: 'PEV', 4: 'Gas', 5: 'PEV', 6: 'Gas', 7: 'PEV'}}
    )
