...
@orca.step()
def trip_mode_choice_simulate(trips,
    ...
    if trace_hh_id:
        ...
        trace_columns = ['trip_mode']

        # FIXME - TRIPID is dependent on hh, person, tour id so can't re-create a pandas table
