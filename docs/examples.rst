...
+---------------------------------+-----------------------------------------------------------+--------------+----------------------+
| :ref:`example_semcog`           | SEMCOG agency example                                     | 1            | In production        |
+---------------------------------+-----------------------------------------------------------+--------------+----------------------+
...
Additional extensions were included specifically as part of the example_semcog model to deal with the unique travel of
